...
MODULES = {
	...
	"operations": {"label": "Operations", "description": "Projects, assets, departments and support.", "accent": "turquoise"},
...
ENTITY_ROUTES = {
	...
	# SMJ buys direct: pick the goods at the supplier, raise the order, receive
	# and pay. There is no internal stock-request step and no multi-vendor
	# tendering, so Material Request / Request for Quotation / Supplier
	# Quotation are deliberately not routed.
	...
	# SMJ buys ready-made goods and resells them. Manufacturing, subcontracting
	# and incoming-goods quality inspection are deliberately not routed.
	#
...
SPECIAL_ROUTES = {
	...
	"/inventory/warehouse-stock": {"module": "inventory", "label": "Warehouse Stock",
	                               "doctype": "Warehouse", "classification": "register"},
...
REPORT_GROUPS = {
	...
	"operations": ("Project Summary", "Asset Depreciation Ledger"),
}
