...
FORM_SCHEMAS = {
	...
	"payment_entries": {
		"doctype": "Payment Entry", "title": _("Payment Entry"), "back_route": "/finance/payments", "detail_route": "/finance/payments/{name}", "draft_only": True, "create_via_mapping_only": True,
		"fields": (field("payment_type", _("Payment Type"), "Select", options=("Receive", "Pay", "Internal Transfer"), read_only=True, section="payment"), field("party_type", _("Party Type"), "Data", read_only=True, section="payment"), field("party", _("Party"), "Link", options="Customer", read_only=True, section="payment"), field("company", _("Company"), "Link", options="Company", read_only=True, section="payment"), field("posting_date", _("Posting Date"), "Date", section="payment"), field("paid_from", _("Paid From"), "Link", options="Account", section="accounts"), field("paid_to", _("Paid To"), "Link", options="Account", section="accounts"), field("paid_amount", _("Paid Amount"), "Currency", section="payment"), field("received_amount", _("Received Amount"), "Currency", section="payment"), field("paid_from_account_currency", _("Paid From Currency"), "Link", options="Currency", read_only=True, section="accounts"), field("paid_to_account_currency", _("Paid To Currency"), "Link", options="Currency", read_only=True, section="accounts"), field("remarks", _("Remarks"), "Text", section="notes")),
		"sections": (("payment", _("Payment Information")), ("accounts", _("Accounts")), ("notes", _("Notes"))),
		"child_tables": {"references": {"doctype": "Payment Entry Reference", "title": _("References"), "min_rows": 1, "fields": (field("name", "Row ID", "Data", read_only=True), field("reference_doctype", _("Reference Type"), "Data", read_only=True), field("reference_name", _("Reference"), "Data", read_only=True), field("due_date", _("Due Date"), "Date", read_only=True), field("total_amount", _("Total Amount"), "Currency", read_only=True), field("outstanding_amount", _("Outstanding"), "Currency", read_only=True), field("allocated_amount", _("Allocated Amount"), "Currency"))}},
	},
}
