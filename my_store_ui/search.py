...
SEARCH_REGISTRY = (
	...
	{"doctype": "Supplier", "label": "Suppliers", "fields": ("supplier_name", "supplier_group")},
	...
	{"doctype": "Quotation", "label": "Quotations", "fields": ("party_name", "status", "transaction_date")},
	...
	{"doctype": "Material Request", "label": "Material Requests", "fields": ("status", "transaction_date", "company")},
	{"doctype": "Purchase Order", "label": "Purchase Orders", "fields": ("supplier_name", "status", "transaction_date", "grand_total")},
	{"doctype": "Purchase Receipt", "label": "Purchase Receipts", "fields": ("supplier_name", "status", "posting_date", "grand_total")},
	{"doctype": "Purchase Invoice", "label": "Purchase Invoices", "fields": ("supplier_name", "status", "posting_date", "grand_total", "outstanding_amount")},
	...
	{"doctype": "Journal Entry", "label": "Journal Entries", "fields": ("voucher_type", "posting_date", "total_debit")},
	{"doctype": "Lead", "label": "Leads", "fields": ("lead_name", "company_name", "status")},
	{"doctype": "Opportunity", "label": "Opportunities", "fields": ("party_name", "opportunity_from", "status")},
	{"doctype": "Project", "label": "Projects", "fields": ("project_name", "status", "customer")},
	{"doctype": "User", "label": "Users", "fields": ("full_name", "email", "enabled")},
)
