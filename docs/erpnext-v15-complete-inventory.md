...
| `erpnext:doctype:account` | erpnext | Accounts | doctype | Account | B | Yes | /finance/chart-of-accounts | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:appointment` | erpnext | CRM | doctype | Appointment | A | Yes | /crm/appointments | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:asset` | erpnext | Assets | doctype | Asset | B | Yes | /operations/assets | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:asset-movement` | erpnext | Assets | doctype | Asset Movement | B | Yes | /operations/asset-movements | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:batch` | erpnext | Stock | doctype | Batch | A | Yes | /inventory/batches | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:brand` | erpnext | Setup | doctype | Brand | E | Yes | /inventory/brands | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:campaign` | erpnext | CRM | doctype | Campaign | A | Yes | /crm/campaigns | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:company` | erpnext | Setup | doctype | Company | C | Yes | /admin/companies | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:cost-center` | erpnext | Accounts | doctype | Cost Center | C | Yes | /finance/cost-centers | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:customer` | erpnext | Selling | doctype | Customer | A | Yes | /retail-erp/sales/customers | Handcrafted Retail ERP workflow implemented within documented scope | Feature-specific advanced actions and complete interactive role/browser matrix remain |
| `erpnext:doctype:customer-group` | erpnext | Setup | doctype | Customer Group | C | Yes | /crm/customer-groups | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:delivery-note` | erpnext | Stock | doctype | Delivery Note | B | Yes | /retail-erp/sales/delivery-notes | Handcrafted Retail ERP workflow implemented within documented scope | Feature-specific advanced actions and complete interactive role/browser matrix remain |
...
| `erpnext:doctype:department` | erpnext | Setup | doctype | Department | C | Yes | /operations/departments | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:designation` | erpnext | Setup | doctype | Designation | E | Yes | /operations/designations | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:issue` | erpnext | Support | doctype | Issue | A | Yes | /operations/support/issues | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:item` | erpnext | Stock | doctype | Item | B | Yes | /retail-erp/inventory/products | Handcrafted Retail ERP workflow implemented within documented scope | Feature-specific advanced actions and complete interactive role/browser matrix remain |
...
| `erpnext:doctype:item-group` | erpnext | Setup | doctype | Item Group | C | Yes | /inventory/item-groups | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:item-price` | erpnext | Stock | doctype | Item Price | A | Yes | /inventory/item-prices | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:job-card` | erpnext | Manufacturing | doctype | Job Card | B | Yes | /operations/manufacturing/job-cards | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:journal-entry` | erpnext | Accounts | doctype | Journal Entry | B | Yes | /finance/journal-entries | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:lead` | erpnext | CRM | doctype | Lead | A | Yes | /crm/leads | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:material-request` | erpnext | Stock | doctype | Material Request | B | Yes | /purchases/material-requests | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:mode-of-payment` | erpnext | Accounts | doctype | Mode of Payment | A | Yes | /finance/modes-of-payment | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:operation` | erpnext | Manufacturing | doctype | Operation | A | Yes | /operations/manufacturing/operations | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:opportunity` | erpnext | CRM | doctype | Opportunity | A | Yes | /crm/opportunities | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:payment-entry` | erpnext | Accounts | doctype | Payment Entry | B | Yes | /retail-erp/finance/payments | Handcrafted Retail ERP workflow implemented within documented scope | Feature-specific advanced actions and complete interactive role/browser matrix remain |
...
| `erpnext:doctype:payment-request` | erpnext | Accounts | doctype | Payment Request | A | Yes | /finance/payment-requests | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:purchase-invoice` | erpnext | Accounts | doctype | Purchase Invoice | B | Yes | /purchases/invoices | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:purchase-order` | erpnext | Buying | doctype | Purchase Order | B | Yes | /purchases/orders | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:purchase-receipt` | erpnext | Stock | doctype | Purchase Receipt | B | Yes | /purchases/receipts | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:quality-inspection` | erpnext | Stock | doctype | Quality Inspection | B | Yes | /operations/quality-inspections | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:quotation` | erpnext | Selling | doctype | Quotation | B | Yes | /sales/quotations | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:request-for-quotation` | erpnext | Buying | doctype | Request for Quotation | B | Yes | /purchases/requests-for-quotation | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:routing` | erpnext | Manufacturing | doctype | Routing | A | Yes | — | Not implemented | Required for ordinary-user parity |
| `erpnext:doctype:sales-invoice` | erpnext | Accounts | doctype | Sales Invoice | B | Yes | /retail-erp/sales/invoices | Handcrafted Retail ERP workflow implemented within documented scope | Feature-specific advanced actions and complete interactive role/browser matrix remain |
| `erpnext:doctype:sales-order` | erpnext | Selling | doctype | Sales Order | B | Yes | /retail-erp/sales/orders | Handcrafted Retail ERP workflow implemented within documented scope | Feature-specific advanced actions and complete interactive role/browser matrix remain |
...
| `erpnext:doctype:sales-person` | erpnext | Setup | doctype | Sales Person | C | Yes | /crm/sales-people | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:stock-entry` | erpnext | Stock | doctype | Stock Entry | B | Yes | /inventory/stock-entries | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:stock-reconciliation` | erpnext | Stock | doctype | Stock Reconciliation | B | Yes | /inventory/reconciliations | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:subcontracting-order` | erpnext | Subcontracting | doctype | Subcontracting Order | B | Yes | /operations/subcontracting/orders | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:subcontracting-receipt` | erpnext | Subcontracting | doctype | Subcontracting Receipt | B | Yes | /operations/subcontracting/receipts | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:supplier` | erpnext | Buying | doctype | Supplier | A | Yes | /purchases/suppliers | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:supplier-group` | erpnext | Setup | doctype | Supplier Group | C | Yes | /purchases/supplier-groups | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:supplier-quotation` | erpnext | Buying | doctype | Supplier Quotation | B | Yes | /purchases/supplier-quotations | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:task` | erpnext | Projects | doctype | Task | C | Yes | /operations/tasks | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:territory` | erpnext | Setup | doctype | Territory | C | Yes | /crm/territories | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:warehouse` | erpnext | Stock | doctype | Warehouse | C | Yes | /inventory/warehouses | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:doctype:work-order` | erpnext | Manufacturing | doctype | Work Order | B | Yes | /operations/manufacturing/work-orders | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
| `erpnext:doctype:workstation` | erpnext | Manufacturing | doctype | Workstation | A | Yes | /operations/manufacturing/workstations | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `erpnext:report:accounts-payable` | erpnext | Accounts | report | Accounts Payable | D | Yes | /retail-erp/reports/view/Accounts%20Payable | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:accounts-receivable` | erpnext | Accounts | report | Accounts Receivable | D | Yes | /retail-erp/reports/view/Accounts%20Receivable | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:asset-depreciation-ledger` | erpnext | Accounts | report | Asset Depreciation Ledger | D | Yes | /retail-erp/reports/view/Asset%20Depreciation%20Ledger | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:balance-sheet` | erpnext | Accounts | report | Balance Sheet | D | Yes | /retail-erp/reports/view/Balance%20Sheet | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:bank-reconciliation-statement` | erpnext | Accounts | report | Bank Reconciliation Statement | D | Yes | /retail-erp/reports/view/Bank%20Reconciliation%20Statement | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:cash-flow` | erpnext | Accounts | report | Cash Flow | D | Yes | /retail-erp/reports/view/Cash%20Flow | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:customer-ledger-summary` | erpnext | Accounts | report | Customer Ledger Summary | D | Yes | /retail-erp/reports/view/Customer%20Ledger%20Summary | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:general-ledger` | erpnext | Accounts | report | General Ledger | D | Yes | /retail-erp/reports/view/General%20Ledger | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:item-wise-purchase-register` | erpnext | Accounts | report | Item-wise Purchase Register | D | Yes | /retail-erp/reports/view/Item-wise%20Purchase%20Register | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:item-wise-sales-register` | erpnext | Accounts | report | Item-wise Sales Register | D | Yes | /retail-erp/reports/view/Item-wise%20Sales%20Register | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:lead-details` | erpnext | CRM | report | Lead Details | D | Yes | /retail-erp/reports/view/Lead%20Details | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:opportunity-summary-by-sales-stage` | erpnext | CRM | report | Opportunity Summary by Sales Stage | D | Yes | /retail-erp/reports/view/Opportunity%20Summary%20by%20Sales%20Stage | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:profit-and-loss-statement` | erpnext | Accounts | report | Profit and Loss Statement | D | Yes | /retail-erp/reports/view/Profit%20and%20Loss%20Statement | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:project-summary` | erpnext | Projects | report | Project Summary | D | Yes | /retail-erp/reports/view/Project%20Summary | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:purchase-order-analysis` | erpnext | Buying | report | Purchase Order Analysis | D | Yes | /retail-erp/reports/view/Purchase%20Order%20Analysis | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:purchase-register` | erpnext | Accounts | report | Purchase Register | D | Yes | /retail-erp/reports/view/Purchase%20Register | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:sales-analytics` | erpnext | Selling | report | Sales Analytics | D | Yes | /retail-erp/reports/view/Sales%20Analytics | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:sales-order-analysis` | erpnext | Selling | report | Sales Order Analysis | D | Yes | /retail-erp/reports/view/Sales%20Order%20Analysis | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:sales-register` | erpnext | Accounts | report | Sales Register | D | Yes | /retail-erp/reports/view/Sales%20Register | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:stock-analytics` | erpnext | Stock | report | Stock Analytics | D | Yes | /retail-erp/reports/view/Stock%20Analytics | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:stock-balance` | erpnext | Stock | report | Stock Balance | D | Yes | /retail-erp/reports/view/Stock%20Balance | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
| `erpnext:report:stock-ledger` | erpnext | Stock | report | Stock Ledger | D | Yes | /retail-erp/reports/view/Stock%20Ledger | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:stock-projected-qty` | erpnext | Stock | report | Stock Projected Qty | D | Yes | /retail-erp/reports/view/Stock%20Projected%20Qty | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:supplier-ledger-summary` | erpnext | Accounts | report | Supplier Ledger Summary | D | Yes | /retail-erp/reports/view/Supplier%20Ledger%20Summary | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:trial-balance` | erpnext | Accounts | report | Trial Balance | D | Yes | /retail-erp/reports/view/Trial%20Balance | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `erpnext:report:work-order-summary` | erpnext | Manufacturing | report | Work Order Summary | D | Yes | /retail-erp/reports/view/Work%20Order%20Summary | Permission-aware report viewer provisional | Interactive filter/chart/PDF verification remains |
...
| `frappe:doctype:address` | frappe | Contacts | doctype | Address | A | Yes | /crm/addresses | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `frappe:doctype:contact` | frappe | Contacts | doctype | Contact | A | Yes | /crm/contacts | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `frappe:doctype:role` | frappe | Core | doctype | Role | E | Yes | /admin/roles | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
...
| `frappe:doctype:user` | frappe | Core | doctype | User | E | Yes | /admin/users | Generated provisional list/detail/form and allowlisted action coverage | Per-feature transaction, collaboration and interactive browser graduation remains |
