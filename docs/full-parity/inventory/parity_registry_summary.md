...
- Implemented in some form (custom/provisional/adapter/unverified): **876**
...
| internal | Technical/internal, no user route required | 891 |
| not_required | Not needed for this business | 178 |
| unavailable_with_reason | Inventoried, intentionally not yet available (planned) | 537 |
