...
- Implemented in some form (custom/provisional/adapter/unverified): **927**
...
| unavailable_with_reason | Inventoried, intentionally not yet available (planned) | 400 |
