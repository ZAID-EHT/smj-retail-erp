...
- Implemented in some form (custom/provisional/adapter/unverified): **953**
...
| implemented_unverified | Implemented, lacks browser/role/business verification | 168 |
| internal | Technical/internal, no user route required | 976 |
| not_required | Not needed for this business | 181 |
| unavailable_with_reason | Inventoried, intentionally not yet available (planned) | 372 |
