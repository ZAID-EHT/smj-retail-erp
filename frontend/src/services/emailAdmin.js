const PREFIX = "/api/method/my_store_ui.email_admin.";
...
async function call(method, signal) {
  ...
  if (!response.ok || payload.exc) {
    ...
    throw new Error(message || "Email administration is unavailable.");
  }
  return payload.message;
}

export const getEmailOverview = (signal) => call("get_email_overview", signal);
export const getNotificationCoverage = (signal) => call("get_notification_coverage", signal);
